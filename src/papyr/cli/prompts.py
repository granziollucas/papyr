...
PROMPT_DRY_RUN = "Step 12/14: Dry run? values: yes or no"
PROMPT_OUTPUT_FORMAT = "Step 13/14: Output format: xlsx (default), csv, or tsv"
PROMPT_PARALLEL = "Step 14/14: Run providers in parallel? values: yes or no"
